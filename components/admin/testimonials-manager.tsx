...
const initialTestimonials = [
  {
    ...
    rating: 5,
    text: {
      es: "Hermosisimo el lugar , súper tranquilo , ideal para descansar , cerca de todo , la atención de Claudia y Angel excelente , son muy atentos a lo que necesitas , fuimos 9 días y la pasamos genial , yo fui con mí perrita y ella sentía como en su casa , volveremos !!!!",
  ...
  },
  {
    ...
    location: "Local Guide · Nivel 7",
    rating: 5,
    text: {
      es: "La verdad es un lugar muy hermoso y agradable, atendido por sus dueños, muy amables y excelentes personas, la calidez humana recibida por parte de Angel y Claudia, sin palabras. Muy atentos para con sus huéspedes. Las habitaciones son cómodas y con las instalaciones en muy buen estado. Recomendable. Cuenta con servicio de Wifi, piscina y un amplio jardín donde poder sentarte a disfrutar de la naturaleza y la tranquilidad. Volvería las veces que sea necesaria y haya disponibilidad habitacional. La pasamos muy bien con mi ahijado y sus padres.",
  ...
  },
  {
    ...
    location: "Local Guide · Nivel 5",
    rating: 4,
    text: {
      es: "Hermoso lugar! Ideal para descansar y esta cerca de las termas. Los dptos están bien equipados y lo mejor de todo es la atención y buena predisposición. Sin dudas volveríamos.",
  ...
  },
  {
    ...
    location: "Local Guide · Nivel 4",
    rating: 5,
    text: {
      es: "Hermoso lugar. Lindo, limpio y cómodo. Angel fue muy atento!! Volveremos en nuestra próxima visita a Federación.",
